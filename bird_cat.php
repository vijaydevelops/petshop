...
<html lang="en">
    <head>
		...
		<style>
			...
			.birdcat-carousel .owl-item:nth-child(odd) h3 {
				color: red;
			}
			.birdcat-carousel .owl-item:nth-child(even) h3 {
				color: #000;
			}
		</style>
    ...
    <body>
            ...
            <div class="container">
                <div class="row align-items-center">
					...
					<div class="col-lg-4 col-md-6">
                        <div class="logo">
                            <a href="<?php echo $gotoMain; ?>entry.php">
                                <h1><center><B><font size ="3"><font color="red"><font name="sans-serif">BIRD CATEGORIES</font></font></font></B></</h1></center>
		...
		<script>
			...
			function loadInnerPanel(panelName){
				...
				let loadPage = 'bird_cat_panel.php';
				let panelNames;
				if(panelName){
