...
<html lang="en">
    <head>
		...
		<style>
			...
			.entry-carousel .owl-item:nth-child(odd) h3 {
				color: red;
			}
			.entry-carousel .owl-item:nth-child(even) h3 {
				color: #000;
			}
		</style>
					...
					<div class="col-lg-4 col-md-6">
                        <div class="logo">
                            <a href="<?php echo $gotoMain; ?>entry.php">
                                <h1><center><B><font size ="3"><font color="red"><font name="sans-serif">ENTRY</font></font></font></B></</h1></center>
