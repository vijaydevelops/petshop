...
<body>
<div class="topnav">
            <a class="active" href="home.html"><img src="cute-black-dog-icon-vector-13499587".jpg></a>
...
<fieldset>
<input type="text" name="id" placeholder=" Enter animal_id" style="width:100%;height:30px;
   border: 2px solid  #4CAF50; border-radius:3px;background:transparent;" required  >
    <br><br>
   <input type="text" name="category" placeholder="Enter animal_category" style="width:100%;height:30px;
   border: 2px solid  #4CAF50; border-radius:3px;background:transparent;" required  >
   <br><br>
  
  <input type="text" name="name"  placeholder="Enter animal name" style="width:100%;height:30px;
   border: 2px solid  #4CAF50; border-radius:3px;background:transparent;" required >
  <br><br>
 ...
 <input type="number" step=any name="height"  placeholder="Enter height" style="width:300px;height:30px;
  ...
  <br><br>
  <input type="text" name="product"  placeholder="Enter product" style="width:280px;height:30px;
   border: 2px solid  #4CAF50; border-radius:3px;background:transparent;"  required >
 
  <input type="text" name="colour"  placeholder="Enter colour" style="width:300px;height:30px;
   border: 2px solid  #4CAF50; border-radius:3px;background:transparent;"  required >
  <br><br>
