...
<body>
<div class="topnav">
            <a class="active" href="home.html"><img src="birds.jpg"></a>
...
<fieldset>
  <input type="text" name="id" placeholder=" Enter bird_id" style="width:100%;height:30px;
   border: 2px solid  rgba(44, 130, 201, 1); border-radius:3px;  background:transparent;"  required>
  <br><br>
   <input type="text" name="category" placeholder=" Enter bird_category"  style="width:100%;height:30px;
   border: 2px solid  rgba(44, 130, 201, 1); border-radius:3px;  background:transparent;"  required>
  <br><br>
   <input type="text" name="type" placeholder=" Enter bird type"  style="width:100%;height:30px;
   border: 2px solid  rgba(44, 130, 201, 1); border-radius:3px;  background:transparent;"  required>
  <br><br>
  <input type="text" name="product" placeholder="Enter product" style="width:100%;height:30px;
