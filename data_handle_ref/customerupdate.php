...
<input type="text" name="id" placeholder="Enter the customer id" style="width:100%;height:30px;
 ...
 <input type="text" name="name" placeholder="Enter customer name" style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
   <input type="text" name="product" placeholder="Enter customer product" style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
   <input type="text" name="number" placeholder="Enter customer number" style="width:100%;height:30px;
    border: 2px solid #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
  <input type="text" name="date" placeholder="Enter customer date" style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
