...
<div class="topnav" style="padding-bottom: 0px;">
    ...
    <h4 style="display: inline; color: rgba(255,255,255,0.9); "> Animal Categories </h4>
</div>
...
<div class="entry_form" style="display: none;">
    ...
    <form method="post" style="width: 50%; margin-left: 50px;"> 
        <fieldset> 
            ...
            <input type="text" name="name" placeholder="Enter animal category name" class="input-el row-b" required>
            <br>

            <input type="text" name="description" placeholder="Enter animal category description"  class="input-el row-c" >
            <br>
...
<script>
    ...
    function refreshInnerPanel(){
        ...
        let loadPage = 'animal_cat_form.php';
        $('.refresh-label').show()
        fetch(loadPage, {
            method: 'POST',
            body: JSON.stringify({
