...
<?php  
	...
	if($con){
        ...
        $no_of_bird_cat = mysqli_num_rows($var);
        ...
        <div class="carousel">
            <div class="container-fluid">
                <div class="owl-carousel birdcat-carousel">
                <?php
                    ...
                    <div class="carousel-item">
						<div class="carousel-box" onclick="triggerInnerAnchorClick(event, this)" style="background: url('<?php echo $arr['picfilepath']; ?>'); background-size: contain; background-repeat: no-repeat; background-position: center;">
							...
							<div class="carousel-text" style="text-align: center; width: 90%; margin-top: calc( 20vh + 40px ); color: #333 !important;
								...
								<a href="<?php echo $gotoMain; ?>bird_panel.php?cat_id=<?php echo $arr['id']; ?>">
...
<script>
	$(".carousel .birdcat-carousel").owlCarousel({
		autoplay: true,
		animateOut: 'fadeOut',
		animateIn: 'fadeIn',
		items: ( <?php echo $no_of_bird_cat; ?> < 3 ? <?php echo $no_of_bird_cat ?> : 3 ),
		smartSpeed: 300,
		dots: false,
		loop: true,
		nav : true,
